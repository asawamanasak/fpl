...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=JetBrains+Mono:wght@400;600;700&family=Prompt:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    <style>
        :root {{
            --bg-base: #090c10;
            --bg-surface: #0f141c;
        ...
        * {{ margin: 0; padding: 0; box-sizing: border-box; -webkit-tap-highlight-color: transparent; }}
        ...
        @media (max-width: 768px) {{
            ...
            .manager-meta-line {{ font-size: 0.66rem; line-height: 1.4; color: var(--text-secondary); margin-top: 2px; word-break: keep-all; }}
