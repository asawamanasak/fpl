...
def monitor_press_conferences_and_injuries(bs):
    ...
    # Monitored Core Targets (Choice 1 & Choice 2 Key Players: 15 Squad Players + Key Targets)
    monitored_pids = [109, 391, 277, 4, 124, 368, 154, 464, 411, 496, 165, 304, 31, 15, 68]
