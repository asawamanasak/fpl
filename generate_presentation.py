    ...
    <style>
        ...
        * {{ margin: 0; padding: 0; box-sizing: border-box; -webkit-tap-highlight-color: transparent; }}
        ...
        @media (max-width: 768px) {{
            ...
            .starter-card {{ width: 74px; padding: 0.2rem 0.22rem; }}
            .starter-photo-wrap {{ width: 100%; height: 38px; }}
            .starter-shirt-img {{ width: 34px; height: 34px; }}
            .starter-info-card {{ width: 100%; padding: 0.15rem 0.1rem; }}
            .starter-name {{ font-size: 0.62rem; }}
            .starter-meta {{ font-size: 0.5rem; }}
            .starter-fix-row {{ font-size: 0.48rem; }}
            
            .bench-card {{ width: 74px; padding: 0.2rem 0.22rem; }}
            .bench-photo-wrap {{ width: 100%; height: 38px; }}
            .bench-shirt-img {{ width: 34px; height: 34px; }}
            .bench-info-card {{ width: 100%; padding: 0.15rem 0.1rem; }}
            .bench-name {{ font-size: 0.62rem; }}
            .bench-meta {{ font-size: 0.5rem; }}
            .bench-fix-row {{ font-size: 0.48rem; }}

            .pitch-row {{ gap: 0.3rem; }}
            .compact-pitch {{ padding: 0.45rem 0.25rem; min-height: 410px; }}
